                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= Config::$base ?>/router.php?controller=order&action=setInDelivery&orderId=<?= $order->getId() ?>" class="btn btn-info">
                                <i class="bi bi-bag-check"></i>
                                Prendre
                            </a>
                            <?php endif; ?>
                            <?php if ($order->getStatus() === 'delivery') : ?>
                            <a href="<?= Config::$base ?>/router.php?controller=order&action=setDelivered&orderId=<?= $order->getId() ?>" class="btn btn-info">
                                <i class="bi bi-bag-check"></i>
                                Livrée
                            </a>
                            <?php endif; ?>
